...
class CompletionTriggersRelationManager extends RelationManager
{
    protected static string $relationship = 'completionTriggers';
    protected static ?string $title = 'Completion Triggers';
